...
use Habr\Renat\Blog\Exceptions\NotFoundException;
use Habr\Renat\Blog\Repositories\UserRepository\InMemoryUsersRepository;
...
// Описываем ожидаемое исключение
        ...
        $this->expectExceptionMessage(
                'Cannot resolve type: Habr\Renat\UnitTests\Container\SomeClass'
        );
